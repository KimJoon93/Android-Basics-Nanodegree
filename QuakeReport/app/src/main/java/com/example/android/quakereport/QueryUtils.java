...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeData> extraEarthquakes(){
...
//                String time = properties.getString("time");
                ...
                EarthquakeData realearthquakeData = new EarthquakeData(magnitude,location,time);
                earthquakeData.add(realearthquakeData);
            }

        }catch (JSONException e){
            Log.d("TEST","JSONERROR!!!!!");
        }
